        ...
        return (
          <div
            ...
            className={`flex items-center justify-center text-sm font-semibold transition-colors ${disabled ? "" : "cursor-pointer"} ${
              selected ? "text-emerald-800" : "text-gray-400"
            }`}
...
export default function TimeWheelPicker({ value, onChange, minuteStep = 1, disabled = false, label }) {
  ...
  return (
    <div className={disabled ? "opacity-50" : ""}>
      ...
      <div
        className="relative inline-flex items-stretch gap-1 bg-white border border-gray-200 rounded-lg px-2 py-1"
        style={{ pointerEvents: disabled ? "none" : "auto" }}
      >
        <div
          className="pointer-events-none absolute left-2 right-2 bg-gray-100 rounded-md"
        ...
        <div className="flex items-center justify-center text-sm font-semibold text-gray-400" style={{ height: VIEWPORT_HEIGHT }}>:</div>
