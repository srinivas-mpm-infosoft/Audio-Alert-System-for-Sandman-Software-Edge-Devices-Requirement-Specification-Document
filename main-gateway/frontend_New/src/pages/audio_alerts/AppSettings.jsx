  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className={SECTION}>
        <div className="border-b border-slate-100 pb-3 mb-4 flex items-center justify-between">
          <div>
            <h3 className="font-semibold text-slate-800">Shift Times</h3>
            <p className="text-xs text-slate-400 mt-0.5">Start/end times for each production shift — used by shift-based scheduling and language assignment</p>
          </div>
        ...
        {shiftLoading ? <LoadingRow /> : !shiftLocal ? (
          <p className="text-slate-400 text-sm">Could not load shift times.</p>
        ) : (
          <div className="space-y-2">
            {["Morning", "Afternoon", "Night"].map((shift) => (
              <div key={shift} className="grid grid-cols-1 sm:grid-cols-3 gap-4 items-end rounded-xl border border-slate-200 bg-slate-50/60 px-4 py-3">
