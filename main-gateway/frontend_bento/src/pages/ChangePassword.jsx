...
export default function ChangePassword() {
    ...
    return (
        <div className="flex flex-col h-full overflow-hidden bg-gray-50 ">
            ...
            <div className="p-5 border-b border-gray-100 bg-gray-50/50 flex items-center gap-3 ml-4 mt-5">
                <KeyRound size={20} />
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        placeholder="••••••••"
                                        className="w-full px-4 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-600 focus:border-emerald-600 transition-all outline-none"
                                    />
                                </div>
                                ...
                                <div className="pt-4 border-t border-gray-100 flex items-center gap-4">
                                    <button
                                        disabled={isPending}
                                        type="submit"
                                        className="flex items-center gap-2 px-6 py-2.5 bg-emerald-800 hover:bg-emerald-900 disabled:bg-emerald-500 text-white font-medium rounded-lg shadow-sm transition-all"
                                    >
