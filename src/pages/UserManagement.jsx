    ...
    <div>
      ...
      <div className="relative">
        <button
          type="button"
          onClick={() => setOpen((o) => !o)}
          className="w-full flex items-center justify-between border border-slate-200 rounded-lg px-3 py-2 text-sm bg-white hover:border-slate-300 text-slate-700"
        >
          <span className={value.length ? "text-slate-700" : "text-slate-400"}>{displayLabel}</span>
  ...
  return (
    <div className="p-6 flex flex-col gap-5 min-h-full">
      ...
      <div className="border-b border-slate-200 pb-4">
        ...
        <p className="text-slate-500 text-sm mt-0.5">Manage users, roles, permissions, and security settings</p>
      </div>
                  ...
                  <table className="w-full text-xs">
                    <thead>
                      <tr className="bg-slate-100 border-b-2 border-slate-200">
                        <th className="px-4 py-3 text-left font-bold text-slate-700 text-[11px] uppercase tracking-wide w-56 sticky left-0 bg-slate-100">
                          Permission
                        </th>
                        {ROLES.map((r) => (
                                        ...
                                        className={`mx-auto flex items-center justify-center w-6 h-6 rounded-md border-2 transition-all ${
                                          isLocked
                                            ...
                                            : has
                                              ...
                                              : "border-slate-300 bg-white text-slate-300 hover:border-rose-400 hover:bg-rose-50 hover:text-rose-400 cursor-pointer"
                                        }`}
            ...
            {!security
              ...
              : (
                <>
                  ...
                  <section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="flex items-center gap-3 pt-5">
                        <input id="sec-complexity" type="checkbox" className="h-4 w-4 rounded border-slate-300 text-indigo-600"
                          checked={security.password_complexity ?? true}
                          onChange={(e) => setSecurity((s) => ({ ...s, password_complexity: e.target.checked }))} />
                        <label htmlFor="sec-complexity" className="text-sm text-slate-700">
                  ...
                  {/* Session Timeouts */}
                  <section>
                    <p className="font-semibold text-slate-800 mb-3">Session Timeout per Role (minutes)</p>
                  ...
                  {/* MFA Required */}
                  <section>
                    <p className="font-semibold text-slate-800 mb-3">Require MFA</p>
                  ...
                  {/* IP Allowlist */}
                  <section>
                    <p className="font-semibold text-slate-800 mb-1">IP Allowlist</p>
                    <p className="text-xs text-slate-400 mb-2">One CIDR per line (e.g. 192.168.1.0/24). Empty = allow all.</p>
                    <textarea
                          ...
                          <div key={tok.id} className="flex items-center justify-between p-3 bg-slate-50 rounded-lg border border-slate-100">
                            <div>
                              <p className="text-sm font-medium text-slate-700 flex items-center gap-1.5">
                                <Key size={12} className="text-slate-400" />{tok.name}
                              </p>
      ...
      {modal && (
        <div className="fixed inset-0 z-[1000] flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-lg mx-4 p-6 z-10 flex flex-col gap-5 max-h-[90vh] overflow-y-auto">
            {/* Header */}
            <div className="flex items-center justify-between">
              <div>
            ...
            <div className="flex gap-1.5">
              {Array.from({ length: maxStep }).map((_, i) => (
                <div key={i} className={`h-1 flex-1 rounded-full transition-colors ${i < wizardStep ? "bg-indigo-500" : "bg-slate-200"}`} />
              ))}
            </div>
            ...
            {wizardStep === 2 && (
              <div className="flex flex-col gap-5">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-400 mt-1">Leave unchecked for all shifts.</p>
                </div>
            ...
            {wizardStep === 3 && modal.mode === "create" && (
              <div className="flex flex-col gap-3">
                <p className="text-sm text-slate-500">Review details before creating.</p>
